...
namespace Microsoft.EntityFrameworkCore.Scaffolding.Internal
{
    ...
    /// </summary>
    public class CSharpEntityTypeGeneratorExtended : ICSharpEntityTypeGenerator
    {
        ...
        ///     doing so can result in application failures when updating to a new Entity Framework Core release.
        /// </summary>
        public CSharpEntityTypeGeneratorExtended(
        ...
        public virtual string WriteCode(IEntityType entityType, string? @namespace, bool useDataAnnotations, bool useNullableReferenceTypes)
        {
            ...
            {
                _sb.AppendLine($"namespace {@namespace}{(_isFileScopedNamespace ? ";" : string.Empty)}");
            ...
            if (!string.IsNullOrEmpty(@namespace) && !_isFileScopedNamespace)
            {
                _sb.DecrementIndent();
                _sb.AppendLine("}");
            }
